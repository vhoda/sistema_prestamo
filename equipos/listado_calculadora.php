...
<head>
    ...
    <title>Listado Equipos - Calculadoras</title>
</head>
<body>
<?php 
include'../menu.php'
...
<div class="col py-3">
    <div class="container">
        <div class="row">
            <div class="col">
                    <h2 class="fw-bolder">Calculadoras <span class="badge text-bg-secondary shadow"><?php
                                  require("../config/conexion.php");
                                  $sql = "SELECT COUNT(tipo)
                                  FROM productos
                                  WHERE productos.tipo='Calculadora'";
            ...
            <table class="table table-hover">
                ...
                <tbody class="table-group-divider">
                    ...
                    <?php
                    require("../config/conexion.php");
                    $datos = $conexion->prepare("SELECT idproductos, marca, modelo, tipo , estado FROM productos WHERE productos.tipo = 'Calculadora'; ORDER BY productos . idproductos DESC");
